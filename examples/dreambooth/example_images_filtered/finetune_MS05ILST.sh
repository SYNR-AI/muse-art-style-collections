...
# -------------------------------------------------------------------------------------------
export OUTPUT_DIR="./trained-flux-lora-exp12/data-v2-finetuned-v1/${TRIGGER}"

export _RESUME_CKPT="./trained-flux-lora-exp11/data-v2/${TRIGGER}/pytorch_lora_weights.safetensors"
export _RESUME_FLAG="--resume_from_checkpoint_sft ${_RESUME_CKPT}"

export _MAX_STEPS=20000
export _CKPT_STEPS=2000
...
# NOTICE:
# hyperparameters
export _EXTRA_ARGS="${_EXTRA_ARGS} ${_RESUME_FLAG}"
export _EXTRA_ARGS="${_EXTRA_ARGS} --random_flip"
...
export _EXTRA_ARGS="${_EXTRA_ARGS} --train_text_encoder --text_encoder_lr=${_T_ENC_LR} --shuffle_captions --keep_n_tokens=0"
