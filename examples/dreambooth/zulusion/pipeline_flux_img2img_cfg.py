...
class FluxImg2ImgCFGPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    r"""
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if do_true_cfg:
                    ...
                    # else:
                    #     # only chunk model prediction
                    #     # i.e. [neg_noise, pos_noise] we only take out the last half
                    #     pass
